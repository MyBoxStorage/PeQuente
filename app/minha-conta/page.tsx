...
export const metadata: Metadata = {
  title: 'Minha Conta - Área do Cliente | Pé Quente Calçados',
  description: 'Acesse sua conta na Pé Quente Calçados. Gerencie seus pedidos, favoritos e informações pessoais. Retirada na loja em Paraíba do Sul, RJ.',
  keywords: ['minha conta', 'área do cliente', 'pedidos', 'favoritos', 'Pé Quente Calçados', 'Paraíba do Sul'],
  openGraph: {
    type: "website",
    locale: "pt_BR",
    url: "https://www.pequentecalcados.com.br/minha-conta",
    siteName: "Pé Quente Calçados",
    title: "Minha Conta - Área do Cliente | Pé Quente Calçados",
    description: "Acesse sua conta na Pé Quente Calçados. Gerencie seus pedidos, favoritos e informações pessoais.",
    images: [
      {
        url: "https://www.pequentecalcados.com.br/images/logo.png",
        width: 1200,
        height: 630,
        alt: "Minha Conta - Pé Quente Calçados",
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://www.pequentecalcados.com.br/minha-conta",
  },
};
